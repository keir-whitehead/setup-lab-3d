...
export const AI_MODEL_DEFS: AIModelDef[] = [
  // === LLMs sorted by VRAM (biggest → smallest) ===
  {
    name: 'GLM-5', params: '744B MoE (40B active)', quant: 'Q4', vramGB: 400,
    category: 'frontier', type: 'llm',
    singleMLX: null, singleOllama: null, exoSpeed: 8,
    exoNote: 'distributed only — needs 400GB+ total RAM, largest open MoE',
    unit: 'tok/s',
    desc: 'Zhipu AI (Feb 2026). 200K context, 131K output. Trained on Huawei Ascend. Record low hallucination.',
    costPerMTokenInput: 0.25, costPerMTokenOutput: 1.00, localCostPerHour: 0.015,
  },
  {
    name: 'Kimi K2.5', params: '1T MoE (32B active)', quant: 'INT4 native', vramGB: 250,
    category: 'frontier', type: 'llm',
    singleMLX: null, singleOllama: null, exoSpeed: 10,
    exoNote: 'distributed only — needs 250GB+ total RAM across cluster',
    unit: 'tok/s',
    desc: 'Moonshot (Jan 2026). 256K context, native multimodal + video. First open-weight model with vision at frontier level.',
    costPerMTokenInput: 0.20, costPerMTokenOutput: 0.80, localCostPerHour: 0.015,
  },
  {
  ...
  {
    name: 'Qwen3 Coder', params: '480B MoE (35B active)', quant: 'Q4_K_M', vramGB: 150,
    category: 'frontier', type: 'llm',
    singleMLX: 15, singleOllama: null, exoSpeed: 12,
    exoNote: '35B active params — needs Ultra 192GB+ or exo cluster',
    unit: 'tok/s',
    desc: 'Alibaba coding specialist (Feb 2026). 256K context. Strongest open-source coder.',
    costPerMTokenInput: 0.18, costPerMTokenOutput: 0.54, localCostPerHour: 0.015,
  },
  {
  ...
  {
    name: 'Qwen 3.5', params: '397B MoE (17B active)', quant: 'Q4_K_M', vramGB: 120,
    category: 'frontier', type: 'llm',
    singleMLX: 22, singleOllama: null, exoSpeed: 16,
    exoNote: 'MoE with 17B active — fast on single Ultra, scales well in exo cluster',
    unit: 'tok/s',
    desc: 'Alibaba flagship (Feb 2026). Native multimodal, agentic. 60% cheaper than Qwen 3. Best MoE efficiency.',
    costPerMTokenInput: 0.12, costPerMTokenOutput: 0.36, localCostPerHour: 0.015,
  },
  {
